...
- **Warehouse mirror — built:** the canonical Postgres store batch-exports to **Snowflake** for analytical workloads at production retention/scale, same schema, mirror not primary — Postgres stays canonical.
